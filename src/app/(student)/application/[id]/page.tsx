      ...
      <div className="rounded-sm border border-blue-200 bg-blue-50 p-6">
        ...
        <div className="mt-6 pt-4 border-t border-blue-200">
          <button
            onClick={async () => {
              ...
              const { data, error } = await supabase.storage
                .from('learning-agreements')
                .createSignedUrl('Modele-Learning-Agreement.pdf', 3600)
              ...
              if (data?.signedUrl) {
                ...
                console.error('No signed URL data:', data)
                toast.error('Impossible de télécharger le modèle (URL vide)')
              }
            }}
          ...
          >
            ...
            Télécharger le modèle de Learning Agreement (PDF)
          </button>
        </div>
      </div>
